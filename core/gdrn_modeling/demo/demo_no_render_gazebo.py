...
class ImageDataHandler:
    def __init__(self):
        ...
        self.topicImageRGB = message_filters.Subscriber("/xtion/rgb/image_rect_color", Image)
        self.topicImageDepth = message_filters.Subscriber("/xtion/depth_registered/image_raw", Image)
...
if __name__ == '__main__':
    ...
    camera_json_path = osp.join(PROJ_ROOT,"core/gdrn_modeling/camera_settings/camera_xtion4simulation_tuda.json")
