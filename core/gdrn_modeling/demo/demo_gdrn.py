...
if __name__ == "__main__":
    ...
    yolo_predictor = YoloPredictor(
                       ...
                       ckpt_file_path=osp.join(PROJ_ROOT,"/gdrnpp_bop2022/output/yolox/bop_pbr/yolox_x_640_augCozyAAEhsv_ranger_30_epochs_ycbv_real_pbr_ycbv_bop_test/model_final.pth"),
                       fuse=True
    )# f9772bd0df52
